...
namespace Euromag.Protocols.StdCommands
{
        ...
        public override IDictionary<int, String> Options
        {
            ...
            { 
                if (_optionList == null)
                {
                    ...
                    _optionList.Add(2, "cubic meter [m3]");
                    _optionList.Add(3, "liter [L]");
                    _optionList.Add(4, "mega liter [ML]");
                    _optionList.Add(5, "cubic foot [ft3]");
        ...
        public override IDictionary<int, String> Options
        {
            ...
            { 
                if (_optionList == null)
                {
                    ...
                    _optionList.Add(3, "cubic meter [m3]");
