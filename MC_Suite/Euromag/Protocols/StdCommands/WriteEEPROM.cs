...
namespace MC_Suite.Euromag.Protocols.StdCommands
{
    ...
    public class WriteEEPROM : StdCommand, IHasWritableVariable
    {
        public WriteEEPROM()
        {
        ...
        public WriteEEPROM(commPortHandler handler)
            : base(handler)
        {

        }

        public WriteEEPROM(String portname)
            : base(portname)
        {
        }
        ...
        {
            return "Write EEPROM Variable Command";
        }
        ...
        {
            get
            { return AllEEPROMVarsLister.getList(); }
        }
        ...
        private const Byte commandFrameType         = 0x11;
        private const Byte answerOkFrameType        = 0x21;
