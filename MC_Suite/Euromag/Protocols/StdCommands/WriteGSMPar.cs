...
namespace MC_Suite.Euromag.Protocols.StdCommands
{
    ...
    public class WriteGSMPar : StdCommand, IHasWritableVariable
    {
        public WriteGSMPar()
        {
        ...
        public WriteGSMPar(commPortHandler handler)
            : base(handler)
        {

        }

        public WriteGSMPar(String portname)
            : base(portname)
        {
        }
        ...
        {
            return "Write WriteGSMPar Variable Command";
        }
        ...
        {
            get
            { return AllGSMVarsLister.getList(); }
        }
        ...
        private const Byte commandFrameType     = 0xD3;
        private const Byte answerOkFrameType    = 0xD4;
        private const Byte answerErrorFrameType = 0xE2; 
